...
- Not submitted for App Review. Apple’s Add for Review validation specifically requires published App Privacy answers, Content Rights Information and a complete review contact. Build 102 is attached; the first subscription must also be included once the remaining setup permits it.
# iOS release setup
